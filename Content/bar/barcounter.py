...
class Counter:
	...
	#type = 'Item'
	visible = True 
	aliases = ['Counter', 'marble counter', 'bar counter']
	descriptions = {'desc': "Bar counter stretches most of the length of the room. The counter top is of fine marble. There are taps with five selections of craft beer. Maybe I should search around the bar counter.",
