...
class Gardens:
	...
	descriptions = {'shortDesc': "You're in the gardens again. Those guys are STILL standing in the corner smoking cigars. " \
					...
					'longDesc': "The back door leads you out to the gardens. This outdoor area is surrounded by tall shrubbery. It's a beautiful night, but everyone seems to care about the bar " \
