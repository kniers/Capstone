...
class Longdesk:
	...
	descriptions = {'LongDeskDesc': "There is a long walnut desk along the wall that seats three. Looks to be a great place to read or study. There is a drawer on the left side of the desk. ",
					'openedDesc': "There is a long walnut desk along the wall that seats three. Looks to be a great place to read or study. There is a drawer on the left side of the desk. The drawer is lined in red velvet. ",
					'bibleDesc': "In the drawer is a beautiful, leather-bound bible with a gilded cross on the cover. The cross has seven half-carat diamonds along the center.",
					'nothingDesc': "There's nothing inside. ",
